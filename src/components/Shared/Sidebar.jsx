...
import { FaHome, FaStore, FaCogs, FaBoxOpen, FaUsers, FaUserTie, FaTags, FaFileAlt, FaShieldAlt, FaSignOutAlt } from 'react-icons/fa';
...
const Sidebar = () => {
    ...
    return (
        <div className='bg-[#016A70] w-[250px] h-[96vh] overflow-y-scroll px-3'>
            <h2 className="text-white text-center py-6 text-3xl font-semibold">CARENES</h2>
            <ul className='text-white'>
                {menuItems.map((item, index) => (
                    <NavLink to={item?.link} key={index} className='flex items-center py-3 rounded-3xl my-1 pl-6 hover:bg-[#014F56] cursor-pointer hover:text-white'>
