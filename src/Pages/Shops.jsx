...
const Shops = () => {
    ...
    const columns = [
        ...
        },
        {
            ...
            key: "shopName",
            render: (text, record) => (
                <div onClick={() => navigate('/shop-details/id')} className="flex items-center space-x-3 cursor-pointer select-none">
                    <img
                        src={record.image}
                        alt="shop"
        ...
        },
        {
            ...
            render: (status) => (
                <span
                    className={`px-4 py-1 rounded-full text-sm ${status === "Active"
